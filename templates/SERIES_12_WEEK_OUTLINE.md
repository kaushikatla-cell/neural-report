...
|------|--------------|--------------------------|---------------------|--------|
| 1 | 2026-04-27 | Has generative AI already raised economy-wide productivity? | IMF + BLS + NBER | **Published** |
...
| 9 | 2026-06-22 | What is a “sovereign AI” stack, and why does trade policy care? | export controls + CRS | Draft |
| 10 | 2026-06-29 | How are public pension funds exposed to private markets—and why does it matter for risk? | NBER / state reports | Draft |
| 11 | 2026-07-06 | What did early AI pricing studies find in digital markets? | Antitrust economics papers | Draft |
| 12 | 2026-07-13 | Wrap: what did NRP get wrong or update this quarter? | Internal + corrections log | Draft |

## Cadence rules

- **Minimum:** 1 Evidence Brief / week → IG points to canonical `docs/briefs/…`.
- **Optional +1:** one Reel or carousel that is **only** a teaser; full claims live on site.
- **Week 8:** “Still uncertain because…” heavy brief (intellectual honesty signal).

## Done checklist

- [x] 12 rows filled with real topics (adjust with a dated note if you pivot).
- [x] Archive updated through week 4.
- [ ] Guest or club touchpoint **initiated** by week 6 (see `outreach/VALIDATION_CHECKLIST.md`).
