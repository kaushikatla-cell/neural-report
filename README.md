...
| **CI: citation freshness (strict + snapshots)** | [`.github/workflows/citation-freshness.yml`](.github/workflows/citation-freshness.yml) (scheduled Wednesdays; artifacts include deltas) |
